...
//        }
//    }
    [[NSNotificationCenter defaultCenter] postNotificationName:@"completionButtonClicked" object:nil userInfo:@{@"deviceSerialNo":[GlobalKit shareKit].deviceSerialNo}];
}
