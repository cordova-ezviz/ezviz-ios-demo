...
//        self.nameLabel.text = self.cameraInfo.deviceName;
    ...
    else if (indexPath.section == 6)//删除
    {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if (indexPath.section == 5)
    {
        ...
        NSString *deviceSerial = self.deviceInfo.deviceSerial;
        EZCameraInfo *cameraInfo = [self.deviceInfo.cameraInfo firstObject];
        hud.labelText = @"正在设置，请稍候...";
